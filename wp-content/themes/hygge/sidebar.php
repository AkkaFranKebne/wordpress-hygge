					...
					<ul class="sidebar menu">
						<li class="mini-posts">
							<a href="#" class="tag">
								...
								<img src="<?php bloginfo('template_url')?>/img/mini1.jpg" alt="related post">
							</a>
						</li>
						<li class="mini-posts">
							<a href="#" class="tag">
								<h5 class="mini-title">Easy (distr)action</h5>
								<img src="<?php bloginfo('template_url')?>/img/mini2.jpg" alt="related post">
							</a>
						</li>
						<li class="mini-posts">
							<a href="#" class="tag">
								<h5 class="mini-title">Meditaion</h5>
								<img src="<?php bloginfo('template_url')?>/img/mini3.jpg" alt="related post">
							</a>
						</li>
					</ul>
				</div>
